  ...
  return (
    <div className="font-sans bg-gray-50 text-gray-800">
      ...
      <header className="bg-gray-900 text-white text-center py-6">
        <h1 className="text-4xl font-bold">FileNest</h1>
      ...
      <section className="bg-gray-100 py-14 px-4">
        <h2 className="text-3xl font-bold text-center mb-12">Why Choose FileNest?</h2>
      ...
      <footer className="bg-gray-900 text-white text-center py-6">
        <p>&copy; {new Date().getFullYear()} FileNest. All rights reserved.</p>
